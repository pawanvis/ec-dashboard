...
const Blogedit = () => {
  ...
  useEffect(() => {
    const fetchBlog = async () => {
      try {
        setLoading(true);
        const res = await axios.get(`https://api.ec-businessschool.in/api/blogs/${id}`);
        const blog = res.data;
        ...
        setExistingImage(blog.blog_img);
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      await axios.put(`https://api.ec-businessschool.in/api/blogs/${id}`, data, {
    ...
    <React.Fragment>
      <div className="flex items-center gap-x-3 mb-5">
        <div>
          ...
          <p className="text-gray-600 mt-1">Edit the Blog Post</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
              ...
              {existingImage && !image && (
                <div className="mb-4">
                  ...
                  <img 
                    src={`https://api.ec-businessschool.in/uploads/${existingImage}`} 
                    alt="Current blog" 
          ...
          <div className="flex justify-end mt-6 gap-4">
            <button
              ...
              className="px-8 py-2.5 text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-8 py-2.5 text-white bg-blue-600 rounded-md hover:bg-blue-700"
            >
